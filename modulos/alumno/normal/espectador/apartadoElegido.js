...
import {traerDatosDeLibrosAVariablesDentroDeMochilaEnApartadoElegido,traerDatosDeLibretasAVariablesDentroDeMochilaEnApartadoElegido} from '../../../../store/actions.js';
			...
			.then((respuesta) => {
				...
				*/
				...
				if(respuesta === "Error"){
					...
					console.log("error linea 75: ",respuesta)
					objeto = {
						nombres: [],
						numerosDeHojas: [],
						idsDeElemento: []
