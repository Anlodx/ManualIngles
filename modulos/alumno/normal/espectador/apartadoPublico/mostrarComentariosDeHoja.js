...
import {ToastAndroid,ActivityIndicator,RefreshControl,TouchableOpacity,TextInput, Image,Text, View, StyleSheet, Alert, SafeAreaView, ScrollView, Picker, StatusBar, Dimensions, FlatList,Modal } from 'react-native';
          ...
          return(
            ...
            <View style={{width: Dimensions.get("window").width , height: (Dimensions.get("window").height) * (0.25)}}>
              <View style={{alignSelf:"center",flexDirection:"row",alignItems:"center",backgroundColor:"red"}}>
                <Text style={{color:"#fff",textAlign:"center",fontSize:17,width: Dimensions.get("window").width * (0.9)}}>Â¿Del 0 a 100 que tanto te gusto el contenido?</Text>
                <Icon name='send' type="material-community" color='blue' size={25} containerStyle={{padding:10,marginLeft:10,marginRight:10}}
                 onPress={()=>{
                   //alert(Calificacion)
                   crearRatingHoja(props.idHoja,datosDeCredencial.matricula,Calificacion,Fecha())
                 }}/>
              </View>
                   ...
                   onPress={()=>{
                     ...
                     if(!SonSoloEspecios(ComentarioPrincipal)){
                       ...
                       setComentarioPrincipal("")
                        ...
                        ToastAndroid.show('Comentario invalido: vacio' , ToastAndroid.SHORT);
                     }
  ...
  const ListaComentarios = (props)=>{
    ...
    const [Detalles, setDetalles] = useState({
      ...
      <View style={{width:"100%",height:25}}/>
                          ...
                          ListEmptyComponent={
                            ()=>(
                              <View style={{width:"80%",height:80,justifyContent:"center",alignSelf:"center",alignItems:"center",backgroundColor:"#00a8ff",padding:8,borderRadius:15}}>
                                      ...
                                      ListEmptyComponent={
                                        ()=>(
                                          <View style={{width:"80%",height:80,justifyContent:"center",alignSelf:"center",alignItems:"center",backgroundColor:"#f9ca24",padding:8,borderRadius:15}}>
                                            <Text style={{textAlign:"center",color:"#686de0",fontSize:20}}>Aún no hay Calificaciones sé el primero =)</Text>
                                          </View>
                                          )
                                      }
                                      renderItem={
