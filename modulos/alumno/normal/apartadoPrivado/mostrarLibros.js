...
const MostrarLibrosDelApartadoPrivado = (props) => {
								...
								},
								{
									...
									onPress: () => {
										...
										.then((respuesta) => {
											...
											if(respuesta === "Exito"){
												//LimpiarCache();
												console.log("trayendo libros nuevamente => ")
												eventos.traerLibros()
												console.log(respuesta)
					...
					<Modal visible={true} onRequestClose={eventos.eventoDeBotonPrincipal} transparent={true}>
						<View style={{backgroundColor: "rgba(1,1,1,.5)", width: "100%", height: "100%", justifyContent: "center", alignItems: "center", }}>
							<View style={{width: "95%", height: "90%", alignItems: "center", backgroundColor:"#c8d6e5", borderRadius:20, overflow: "hidden"}}>
								...
								<Text style={{fontFamily: "Viga-Regular",textAlign: 'center',color:"#fff"}}>Libro Nuevo</Text>
								...
								<ScrollView style={{width: "100%", contentContainerStyle: "center"}}>
									<Text style={{fontFamily: "Viga-Regular",textAlign: 'center'}}>Nombre del libro:</Text>
									<TextInput
...
export default MostrarLibrosDelApartadoPrivado;
